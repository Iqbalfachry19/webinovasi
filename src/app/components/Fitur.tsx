...
function Fitur() {
  return (
    <section className="flex flex-col items-center bg-[#1e1e1e] py-20 xl:flex-row xl:pl-[100px]">
      <div className="flex h-[700px] flex-col space-y-10 xl:h-[600px]">
      ...
      <div className="flex flex-col">
        <h2 className="t h-[200px] w-[450px] text-5xl font-normal text-white xl:h-[400px] xl:w-[490px] xl:text-7xl">
