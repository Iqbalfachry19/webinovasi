...
function WebsiteBuilder() {
  return (
    <div className="mx-auto flex max-w-[1150px] flex-col px-2 py-8 md:flex-row xl:flex-row">
      <div className="relative h-[620px] w-full rounded-xl bg-cover md:ml-20 md:h-[380px] md:w-[320px] xl:h-[600px] xl:w-full xl:bg-contain">
      ...
      <div className="px-10 py-20">
        ...
        <p className="mb-8 w-[100px] text-start font-sans text-2xl md:w-[370px]">
